          ...
          <table className="min-w-full bg-white border border-gray-200">
            <thead>
              <tr>
                ...
                {/* <th className="px-6 py-3 bg-gray-200 text-left text-xs font-semibold texwhite00 uppercase tracking-wider">
                  Sector
                </th> */}
                <th className="px-6 py-3 bg-[#087ABC] text-left text-xs font-semibold text-white uppercase tracking-wider">
                 Contract Value/Rwf
            ...
            <tbody>
              {filteredProjects.map((project) => (
                ...
                >
                  ...
                  <td className="px-3 py-2 whitespace-nowrap"
                  onClick={()=>handleProjectModalClick(project)}
                  >{ project.financial_proposal? project.financial_proposal.toLocaleString():"N/A"}</td>
                  <td className="px-3 py-2 whitespace-nowrap"
                  onClick={()=>handleProjectModalClick(project)}
                  >{project.contract_value? project.contract_value.toLocaleString():"N/A"}</td>
                  <td className="px-3 py-2 whitespace-nowrap"
                  onClick={()=>handleProjectModalClick(project)}
                  >{ project.invoiced_value? project.invoiced_value.toLocaleString():"N/A"}</td>
